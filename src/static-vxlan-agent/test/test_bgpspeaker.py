...
#
# Source: https://raw.githubusercontent.com/faucetsdn/ryu/master/ryu/tests/unit/services/protocols/bgp/test_bgpspeaker.py
# To run: python3 -m unittest test_bgpspeaker.Test_BGPSpeaker
