// Source: https://elixir.bootlin.com/linux/latest/source/tools/testing/selftests/bpf/progs/test_tc_edt.c
//
// Example of code that manages to read the 'tstamp' field in __sk_buf
